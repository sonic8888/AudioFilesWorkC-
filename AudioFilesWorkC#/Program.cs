...
namespace AudioFilesWorkC_
{
    internal class Program
    {
        ...
        static string str_create = "CREATE TABLE T_Trask_Yandex (Id  INTEGER PRIMARY KEY AUTOINCREMENT UNIQUE  NOT NULL, Name  VARCHAR, Artist  VARCHAR, TrackId  VARCHAR, ArtistId  VARCHAR, NameArtist   VARCHAR);";
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                object? res = DbSqlite.ExecuteScalar(sql_conn, str1, com_params);

                if (res != null)
                {
                    int result = Convert.ToInt32(res);
                    Track[] tracks = new Track[result];
